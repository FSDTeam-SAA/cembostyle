    ...
    return AppScaffold(
      ...
      body: ListView(
        ...
        children: const [
          ...
          SizedBox(height: 6),
          Text(
            'This Privacy Policy explains how BHEPPO LLC collects, uses, stores, and protects your information when using the Bheppo App ("App"). By downloading or using the App, you agree to this Privacy Policy.',
            style: TextStyle(
              fontSize: 11,
              height: 1.5,
              color: AppPalette.textSecondary,
          ...
          _PolicySection(
            ...
            lines: [
              ...
              'EU Users (GDPR): If you are located in the European Union, you may have rights under GDPR.',
              'California Residents (CCPA/CPRA): California residents may request access to or deletion of personal information. We do not sell personal information.',
            ],
          ),
          _PolicySection(
